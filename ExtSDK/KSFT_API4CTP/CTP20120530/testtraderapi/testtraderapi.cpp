...
#ifdef _DEBUG
#pragma comment(lib, "../thosttraderapi/Debug/thosttraderapid.lib")
#pragma message("Automatically linking with thosttraderapid.lib")
#else
#pragma comment(lib, "../thosttraderapi/Release/thosttraderapi.lib")
#pragma message("Automatically linking with thosttraderapi.lib")
#endif
...
public: 
	...
	virtual void OnRspUserLogin(CThostFtdcRspUserLoginField *pRspUserLogin, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		// broker id 
		strcpy(Investor.BrokerID, "6A89B428");
		// investor ID 
		strcpy(Investor.InvestorID, "80002");
	...
	virtual void OnRspQryInvestor(CThostFtdcInvestorField *pInvestor, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(TradingAccount.BrokerID, "6A89B428");
			// investor ID 
			strcpy(TradingAccount.InvestorID, "80002");
	...
	virtual void OnRspQryInstrument(CThostFtdcInstrumentField *pInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(InvestorPositionDetail.BrokerID, "6A89B428");
			// investor id
			strcpy(InvestorPositionDetail.InvestorID, "80002");
	...
	virtual void OnRspQryInvestorPositionDetail(CThostFtdcInvestorPositionDetailField *pInvestorPositionDetail, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(InstrumentMarginRate.BrokerID, "6A89B428");
			// investor id
			strcpy(InstrumentMarginRate.InvestorID, "80002");
			// instrument id
			strcpy(InstrumentMarginRate.InstrumentID, "IF1303");
	...
	virtual void OnRspQryInstrumentMarginRate(CThostFtdcInstrumentMarginRateField *pInstrumentMarginRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(InstrumentCommissionRate.BrokerID, "6A89B428");
			// investor id
			strcpy(InstrumentCommissionRate.InvestorID, "80002");
			// instrument id
			strcpy(InstrumentCommissionRate.InstrumentID, "IF1303");
	...
	virtual void OnRspQryInstrumentCommissionRate(CThostFtdcInstrumentCommissionRateField *pInstrumentCommissionRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// instrument ID 
			strcpy(DepthMarketData.InstrumentID, "IF1303");
	...
	virtual void OnRspQryDepthMarketData(CThostFtdcDepthMarketDataField *pDepthMarketData, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(ord.BrokerID, "6A89B428"); 
			// investor ID 
			strcpy(ord.InvestorID, "80002"); 
			// instrument ID 
			strcpy(ord.InstrumentID, "IF1303");
			///order reference 
			strcpy(ord.OrderRef, "9");  
			// user id 
			strcpy(ord.UserID, "80002"); 
			// order price type 
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(QryOrder.BrokerID, "6A89B428");
			// investor ID 
			strcpy(QryOrder.InvestorID, "80002");
			// start time
...
/*
	...
	virtual void OnRspQryOrder(CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		{	
			...
			// broker id 
			strcpy(QryTrade.BrokerID, "6A89B428"); 
			// investor ID 
			strcpy(QryTrade.InvestorID, "80002");
			// start time
			...
			// instructment id
			strcpy(QryTrade.InstrumentID, "IF1303");
	...
	virtual void OnRspQryTrade(CThostFtdcTradeField *pTrade, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(QryInvestorPosition.BrokerID, "6A89B428"); 
			// investor ID 
			strcpy(QryInvestorPosition.InvestorID, "80002");
			// instrument id
			strcpy(QryInvestorPosition.InstrumentID, "IF1303");
	...
	virtual void OnRspQryInvestorPosition(CThostFtdcInvestorPositionField *pInvestorPosition, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		{	
			...
			// broker id
			strcpy(CFMMCTradingAccountKey.BrokerID,"6A89B428");
			// user id
			strcpy(CFMMCTradingAccountKey.InvestorID, "80002");
	...
	virtual void OnRspQryCFMMCTradingAccountKey(CThostFtdcCFMMCTradingAccountKeyField *pCFMMCTradingAccountKey, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id
			strcpy(UserPasswordUpdate.BrokerID,"6A89B428");
			// user id
			strcpy(UserPasswordUpdate.UserID, "80002");
			// old password
	...
	virtual void OnRspUserPasswordUpdate(CThostFtdcUserPasswordUpdateField *pUserPasswordUpdate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id
			strcpy(TradingAccountPasswordUpdate.BrokerID,"6A89B428");
			// account id
			strcpy(TradingAccountPasswordUpdate.AccountID, "80002");
			// old password
	...
	virtual void OnRspTradingAccountPasswordUpdate(CThostFtdcTradingAccountPasswordUpdateField *pTradingAccountPasswordUpdate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id
			strcpy(SettlementInfoConfirm.BrokerID, "6A89B428");
			// investor ID
			strcpy(SettlementInfoConfirm.InvestorID, "80002");
	...
	virtual void OnRspQrySettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(QrySettlementInfo.BrokerID, "6A89B428");
			// investor ID 
			strcpy(QrySettlementInfo.InvestorID, "80002");
			// trading day
	...
	virtual void OnRspQryInvestorPositionCombineDetail(CThostFtdcInvestorPositionCombineDetailField *pInvestorPositionCombineDetail, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(ReqTransfer.BrokerID, "6A89B428"); 
			// AccountID ID 
			strcpy(ReqTransfer.AccountID, "80002");
			// BankPassWord
	...
	virtual void OnRspFromFutureToBankByFuture(CThostFtdcReqTransferField *pReqTransfer, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// AccountID ID 
			strcpy(ReqQueryAccount.AccountID, "80002");
			// BankPassWord
	...
	virtual void OnRspQueryBankAccountMoneyByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(QryTransferSerial.BrokerID, "6A89B428"); 
			// investor ID 
			strcpy(QryTransferSerial.AccountID, "80002");
			// BankID
	...
	virtual void OnRspQryTransferSerial(CThostFtdcTransferSerialField *pTransferSerial, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(QryNotice.BrokerID, "6A89B428");
	...
	virtual void OnRspQryNotice(CThostFtdcNoticeField *pNotice, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (bIsLast == true)
		{
			...
			// broker id 
			strcpy(QryTradingNotice.BrokerID, "6A89B428");
			// investor ID
			strcpy(QryTradingNotice.InvestorID, "80002");
